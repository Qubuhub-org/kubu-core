 ...
 *
 *  KUBU:    Increment mempool limits and accept RBF in steps of 0.0001 KUBU
...
/**
 * KUBU: Default dust limit that is evaluated when considering whether a
...
/**
 * KUBU: Default hard dust limit that is evaluated when considering whether
