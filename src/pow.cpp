...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    // KUBU: Special rules for minimum difficulty blocks with Digishield
    ...
    return CalculateKubuNextWorkRequired(pindexLast, pindexFirst->GetBlockTime(), params);
}
