    ...
    platformStyle(_platformStyle)
{
    ...
    nicknamesPage = new NicknamesPage(this);
    ...
    connect(nicknamesPage, SIGNAL(sendCoins(QString)), this, SLOT(gotoSendCoinsPage(QString)));
}
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    nicknamesPage->setModel(_walletModel);
...
void WalletView::gotoNicknamesPage()
{
    setCurrentWidget(nicknamesPage);
}
