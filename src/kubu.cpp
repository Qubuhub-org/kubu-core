...
// KUBU: Normally minimum difficulty blocks can only occur in between
...
unsigned int CalculateKubuNextWorkRequired(const CBlockIndex* pindexLast, int64_t nFirstBlockTime, const Consensus::Params& params)
{
...
CAmount GetKubuBlockSubsidy(int nHeight, const Consensus::Params& consensusParams, uint256 prevHash)
{
    (void)prevHash;
