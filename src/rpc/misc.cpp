...
UniValue getinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total KUBU balance of the wallet\n"
...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw runtime_error(
            ...
            "\nReturn information about the given KUBU address.\n"
            "\nArguments:\n"
            "1. \"address\"     (string, required) The KUBU address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"address\", (string) The KUBU address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"PsaCGTi7WgYtg6kEeNb9fayaycJVC7i9UL\"")
            + HelpExampleRpc("validateaddress", "\"PsaCGTi7WgYtg6kEeNb9fayaycJVC7i9UL\"")
        );
...
UniValue createmultisig(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are KUBU addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) KUBU address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
            ...
            + HelpExampleCli("createmultisig", "2 \"[\\\"PYYrKuRMkcSRovzPngiKLJ3UYFa8erQ5Ku\\\",\\\"Ph28hNGW8zc87ae38NfwCb2kYs8etcoQ5R\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("createmultisig", "2, \"[\\\"PYYrKuRMkcSRovzPngiKLJ3UYFa8erQ5Ku\\\",\\\"Ph28hNGW8zc87ae38NfwCb2kYs8etcoQ5R\\\"]\"")
        ;
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The KUBU address to use for the signature.\n"
            ...
            + HelpExampleCli("signmessage", "\"PhmtFeTAFUzmRi9bhJhRc6mNsqt2pjCYUD\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"PhmtFeTAFUzmRi9bhJhRc6mNsqt2pjCYUD\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"PhmtFeTAFUzmRi9bhJhRc6mNsqt2pjCYUD\", \"signature\", \"my message\"")
        );
...
UniValue echo(const JSONRPCRequest& request)
{
    if (request.fHelp)
        throw runtime_error(
            ...
            "kubu-cli and the GUI. There is no server-side difference."
        );
