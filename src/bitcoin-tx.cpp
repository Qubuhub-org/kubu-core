...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s kubu-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kubu-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded KUBU transaction") + "\n" +
              "  kubu-tx [options] -create [commands]   " + _("Create hex-encoded KUBU transaction") + "\n" +
              "\n";
