...
const char * const BITCOIN_CONF_FILENAME = "kubu.conf";
const char * const BITCOIN_PID_FILENAME = "kubud.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "KUBU";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/KUBU";
#else
    // Unix
    return pathRet / ".kubu";
#endif
