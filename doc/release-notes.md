...
* Add new DNS seeder for mainnet and testnet (seeds.kubucoin.org and seeds-testnet.kubucoin.org)
* Update `chainparamsseeds.h` with more nodes to make the network more resilient
* Various security fixes

#### Design Changes

* Update P logo for "About Kubu Core" in the help menu
* Add Chinese translation fix in Kubu Core
